...
import org.toasthub.ecommerce.store.ECStoreSvcImpl;

@Service("ECStoreAdminSvc")
public class ECStoreAdminSvcImpl extends ECStoreSvcImpl implements ECStoreAdminSvc, ServiceProcessor {

	@Autowired
	@Qualifier("ECStoreAdminDao")
	ECStoreAdminDao storeAdminDao;
	...
	public void item(RestRequest request, RestResponse response) {
		try {
			storeAdminDao.item(request, response);
		} catch (Exception e) {
	...
	public void save(RestRequest request, RestResponse response) {
		try {
			...
			// save
			storeAdminDao.save(request, response);
	...
	public void delete(RestRequest request, RestResponse response) {
		try {
			storeAdminDao.delete(request, response);
	...
	public void items(RestRequest request, RestResponse response) {
		try {
			storeAdminDao.items(request, response);
	...
	public void itemCount(RestRequest request, RestResponse response) {
		try {
			storeAdminDao.itemCount(request, response);
		} catch (Exception e) {
			utilSvc.addStatus(RestResponse.ERROR, RestResponse.EXECUTIONFAILED, prefCacheUtil.getPrefText("GLOBAL_SERVICE", "GLOBAL_SERVICE_EXECUTION_FAIL",prefCacheUtil.getLang(request)), response);
			e.printStackTrace();
		}
	...
	public void deleteAttachment(RestRequest request, RestResponse response) {
		try {
			storeAdminDao.deleteAttachment(request.getParamLong("ATTACHMENT_ID"));
	...
	public ECAttachmentMeta getAttachment(String fileId) {
		try {
			...
			return storeAdminDao.getAttachment(id);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
