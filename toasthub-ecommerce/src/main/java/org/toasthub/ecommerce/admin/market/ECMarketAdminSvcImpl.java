...
import org.toasthub.ecommerce.market.ECMarketSvcImpl;
import org.toasthub.ecommerce.model.ECStore;

@Service("ECMarketAdminSvc")
public class ECMarketAdminSvcImpl extends ECMarketSvcImpl implements ECMarketAdminSvc, ServiceProcessor {

	@Autowired
	@Qualifier("ECMarketAdminDao")
	ECMarketAdminDao marketAdminDao;
	...
	public void process(RestRequest request, RestResponse response) {
		...
		case "SAVE":
			if (!request.containsParam(PrefCacheUtil.PREFFORMKEYS)) {
				List<String> forms =  new ArrayList<String>(Arrays.asList("EC_MARKET_FORM"));
	...
	public void save(RestRequest request, RestResponse response) {
		try {
			...
			if (inputList.containsKey(GlobalConstant.ITEMID) && inputList.get(GlobalConstant.ITEMID) != null && !"".equals(inputList.get(GlobalConstant.ITEMID))) {
				...
				marketAdminDao.item(request, response);
			...
			// save
			marketAdminDao.save(request, response);
	...
	public void delete(RestRequest request, RestResponse response) {
		try {
			marketAdminDao.delete(request, response);
