...
@Entity
@Table(name = "ec_receipt_item")
public class ECReceiptItem extends ECBaseEntity {

	private static final long serialVersionUID = 1L;
	
	protected ECReceipt receipt;
	...
	// constructors
	public ECReceiptItem() {}
	
	public ECReceiptItem(Long id, int quantity) {
		this.setId(id);
		this.setQuantity(quantity);
	}
	
	public ECReceiptItem(Long id, int quantity, String size, String color) {
		this.setId(id);
		this.setQuantity(quantity);
		this.setSize(size);
		this.setColor(color);
	...
	// Methods
	@JsonIgnore
	@ManyToOne(targetEntity = ECReceipt.class, cascade = {CascadeType.PERSIST,CascadeType.MERGE},fetch = FetchType.LAZY)
	@JoinColumn(name = "receipt_id") 
	public ECReceipt getReceipt() {
		return receipt;
	}
	public void setReceipt(ECReceipt receipt) {
